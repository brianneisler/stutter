...
describe('lang.util index', () => {
  test('has expected methods', () => {
    ...
    expect(mod).toEqualPrintDiff({
      ...
      definitionsToParameterizedFunctions: expect.any(Function),
      definitionsToProtocol: expect.any(Function),
      definitionToType: expect.any(Function),
      dispatcherToMultiFunction: expect.any(Function),
      ...
      functionDefineMeta: expect.any(Function),
      functionDefineParameters: expect.any(Function),
      functionDefineReturns: expect.any(Function),
      ...
      functionsToMultiFunction: expect.any(Function),
