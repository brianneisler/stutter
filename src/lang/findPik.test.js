import findPik from './findPik'

describe('findPik', () => {
  test('finds index in array', () => {
    const array = ['a', 'b', 'c']
    const result = findPik((val) => val === 'b', array)
  ...
  test('finds key in object', () => {
    ...
    const result = findPik((val) => val === 2, object)
    expect(result).toBe('b')
  })

  test('returns undefined if no index is found in array', () => {
    const array = ['a', 'b', 'c']
    const result = findPik((val) => val === 'd', array)
    expect(result).toBe(undefined)
  })

  test('returns undefined if no key is found in object', () => {
    const object = { a: 1, b: 2, c: 3 }
    const result = findPik((val) => val === 4, object)
    expect(result).toBe(undefined)
  })
