...
describe('map', () => {
  ...
  test('calls iteratee with index and character when mapping over string', () => {
    ...
    expect(iteratee).toHaveBeenNthCalledWith(1, 'f', 0)
    expect(iteratee).toHaveBeenNthCalledWith(2, 'o', 1)
    expect(iteratee).toHaveBeenNthCalledWith(3, 'o', 2)
