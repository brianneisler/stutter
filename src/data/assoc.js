import { baseCastPath } from '../common/castPath'
import { baseSetPath } from '../common/setPath'
import allWith from '../common/allWith'
import always from '../common/always'
...
const baseAssoc = (selector, value, collection) => {
  ...
  let parts = selector
  if (!isArray(selector)) {
    parts = baseCastPath(selector, collection)
  }
  return baseAssocPath(parts, value, collection)
}
 ...
 * @since v0.1.0
 * @category data
 * @param {*} selector The property path to set or functional selector
